...
This is a simple shell by Mark Asante and Joejo Turkson.
It executes commands, including those with arguments.It follows the betty style guide It can be used with or without a full path name.
